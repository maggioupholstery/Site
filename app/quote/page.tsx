 ...
 * - Stores formatted string in state (nice UX).
 * - You can always strip non-digits when validating/sending.
 */
    ...
    try {
      ...
      const res = await fetch("/api/quote", {
        ...
        body: JSON.stringify({
          ...
          name: trimmedName,
          email: trimmedEmail,
          phone, // keep formatted for readability; API can store it
          notes,
          photoUrls,
        }),
      });
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <label className="text-sm">
                  ...
                  <input
                    ...
                    className={`${fieldClass} ${
                      error && (!phoneDigits || !phoneLooksValid)
