      ...
      <div className="mx-auto max-w-md px-4 py-16">
        ...
        <Card className="mt-6 rounded-[2rem] border-zinc-900 bg-zinc-950/70">
          <CardContent className="p-6 space-y-4">
            ...
            <Button onClick={onLogin} disabled={loading || !password} className="rounded-2xl h-11 w-full">
              {loading ? "Signing in..." : "Sign in"}
            </Button>

            <div className="text-xs text-zinc-500">
              Tip: set <span className="text-zinc-300 font-mono">ADMIN_PASSWORD</span> in Vercel Environment Variables.
            </div>
          </CardContent>
        </Card>
      </div>
